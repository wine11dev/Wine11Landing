    ...
    <section id="how" className="how-it-works">
      ...
      <div className="steps">
        <div className="step">
          ...
          <h3><span className="step-number">1</span> <strong>Order</strong></h3>
          <p>Use our straightforward system to select your desired beverages.</p>
        </div>

        <div className="step">
          <img src={step2} alt="Delivery" />
          <h3><span className="step-number">2</span> <strong>Delivery</strong></h3>
          <p>Our swift Winebulance is on its way to you!</p>
        </div>

        <div className="step">
          <img src={step3} alt="Drink" />
          <h3><span className="step-number">3</span> <strong>Drink</strong></h3>
